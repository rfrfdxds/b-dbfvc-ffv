...
setInterval(() => { // CODE BY KAHRBAA كههربا
  http.get(`http://iuuuuu-tr.glitch.me/`);
}, 280000);
...
const prefix = "*"; // البرافيكس
   const GUILDID = '711366064667361292'; // اي دي السيرفر  
   const CHANNELID = '725124528644030555'; // اي دي الروم
//======================================[Client]======================================
// CODE BY KAHRBAA كههربا

client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("اليوم السعيد للجميع🌙⚡",{type: ''})
});
// CODE BY KAHRBAA كههربا
